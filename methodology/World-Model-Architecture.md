...
- **Deepened so far** (v0.1 each, rows promoted to `draft`): [`Security-Ownership-and-Access.md`](./Security-Ownership-and-Access.md) (S), [`Registry-and-Ledger.md`](./Registry-and-Ledger.md) (R1/R2), [`Actions-and-Events.md`](./Actions-and-Events.md) (K2/X1, the world's verbs), [`Offense-and-Enforcement.md`](./Offense-and-Enforcement.md) (A18, the sharpest rights surface), [`Property-and-Ownership.md`](./Property-and-Ownership.md) (P2/M3/U1/F8, the property-bearing nouns), [`Civic-Health-and-Democracy.md`](./Civic-Health-and-Democracy.md) (B10/A10/A13, the civic layer). Next passes (on demand, by priority): the economy-production layer (C1 business, K8 manufacturing, C2 market), then the flows layer (F1 energy, F3 logistics, F6 emissions).
