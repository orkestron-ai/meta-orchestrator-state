...
*Owner archetypes:* nature has no owner in the property sense at the model level: P namespaces are stewarded by **commons stewards** (the Ecology and Territory sub-agents), consistent with the commons doctrine in [Property, Rent and the Commons](./Property-Rent-and-Commons.md). Parcel-level *rights* over land and subsoil are not stored here; they are S1-ownership records referencing P2/P5 objects.
...
- **Deepened so far** (v0.1 each): [`Security-Ownership-and-Access.md`](./Security-Ownership-and-Access.md) (S), [`Registry-and-Ledger.md`](./Registry-and-Ledger.md) (R1/R2), [`Actions-and-Events.md`](./Actions-and-Events.md) (K2/X1, the world's verbs), [`Offense-and-Enforcement.md`](./Offense-and-Enforcement.md) (A18, the sharpest rights surface), [`Property-and-Ownership.md`](./Property-and-Ownership.md) (P2/M3/U1/F8, the property-bearing nouns), [`Civic-Health-and-Democracy.md`](./Civic-Health-and-Democracy.md) (B10/A10/A13, the civic layer), [`Economy-and-Markets.md`](./Economy-and-Markets.md) (C1/K8/C2, the economy-production layer; K8 row promoted to `draft` in `world-models.csv`, and C1/C2 are core-kernel models in `meta-models.csv` now covered by this spec), [`Energy-Logistics-and-Emissions.md`](./Energy-Logistics-and-Emissions.md) (F1/F3/F6, the flows layer: energy, goods movement and emissions plus the network commons, the flow-value binding and resilience), [`Missions-Science-and-Ecology.md`](./Missions-Science-and-Ecology.md) (D1/D2/D4, the civilization layer: missions, science and ecology plus long-horizon governance, slow-value booking and the integrity surface; D1/D2/D4 are core-kernel models in `meta-models.csv` covered by this spec), [`Documents-Data-and-Software.md`](./Documents-Data-and-Software.md) (N1/N3/N4, the knowledge layer: documents, datasets and software plus the provenance substrate, the licensing and knowledge-commons rights layer, and the information value doctrine), [`Organizations-Contracts-and-Employment.md`](./Organizations-Contracts-and-Employment.md) (O1/O5/O3, the organizations layer: organizations, commercial contracts and employment plus governance and control, the labor value doctrine, and the integrity and capture surface), [`Persons-Life-Events-and-Property.md`](./Persons-Life-Events-and-Property.md) (B1/B12/B11/B3, the people-and-society layer: the natural person, life events and the civil register, household and family, and personal property, plus capacity and guardianship and the person-layer integrity and capture surface; B11/B12 promoted to `draft` in `world-models.csv`, and B1/B3 are core-kernel models in `meta-models.csv` covered by this spec), [`Buildings-Infrastructure-and-Settlement.md`](./Buildings-Infrastructure-and-Settlement.md) (U1/U3 and the whole built environment: buildings and premises, physical infrastructure networks, utility service points and connection, construction and works, settlement and planning and addressing, and the built-environment integrity surface; the physical and place view referencing Property U1 title and the housing floor, the C1-I7 monopoly returns and C1-I16 escrow, and F1 metering and the flows rather than re-modelling them; U2/U3/U4/U5/U6/U7 promoted to `draft` in `world-models.csv`), [`Social-Provision-and-Public-Health.md`](./Social-Provision-and-Public-Health.md) (B13/B14, the social-provision and public-health layer: the benefit and its delivery, social care, eligibility and administration, population health and epidemiology, public-health measures and the coercion threshold, and the integrity surface; the administration and delivery surface around COMP-I17 referencing the distributive-justice floor magnitudes, the B10 subject-owned health record and the HACC gates, the A18-I4 coercion threshold, and the S5 cohort-grain sensing rather than re-modelling them; B13/B14 promoted to `draft` in `world-models.csv`), [`Mobility-Communications-and-Spectrum.md`](./Mobility-Communications-and-Spectrum.md) (F7/F9, the mobility and communications flows: passenger mobility and the freedom of movement, transit systems and operators, communications carriage and net neutrality, spectrum and the transmission commons, communications and mobility privacy, and the integrity surface; enabling flows that ride on U3 and cite the F3 carriage pattern, the F3-I18 data sovereignty, the NET-I2/P2-I7 spectrum commons grant, the C1-I7 monopoly corridor, and the A18-I4 coercion gate rather than re-modelling them, a flow never owning the content or commons it carries; F7/F9 promoted to `draft` in `world-models.csv`), [`Money-Essential-Supply-and-Waste.md`](./Money-Essential-Supply-and-Waste.md) (F2/F4/F5, the money, essential-supply and waste flows: currency and issuance, payments and the payment-access floor, water and food supply chains and safety, the water and food capability floor, waste and circular flows, and the integrity surface; money is the $ rail medium never Ae value, referencing the R2 two-ledger system and cash-like tier, the K8-I10 waste-to-product rule, the F8 instruments, the P2-I7 water commons, and the A18-I4 coercion gate rather than re-modelling them; F2/F4/F5 promoted to `draft` in `world-models.csv`), [`State-Apparatus-and-Interaction-Events.md`](./State-Apparatus-and-Interaction-Events.md) (A5/A11/A12/A14 + X2/X3/X4/X5, the un-deepened state-apparatus instruments and the events/interactions substrate: law in force, public office, registry mandates and permits, encounters and situations, incidents and phenomena, and the integrity surface; every state act bearered, audited, and A18-I4-gated, referencing the governance kernel A0/A1/A9, A2/A3/A4, A6, A10/A13, A18, RES, R1/R5 rather than re-modelling it; A11/A12/A14 and X2/X3/X4/X5 promoted to `draft` in `world-models.csv`). World-coverage rows are promoted to `draft` as each is deepened; core-kernel models (C1, C2, D1, D2, D4, B1, B3) keep their `Formalize`/`Priority` flags in the kernel register. Next passes (on demand, by priority): the state's outward face (A15 interstate relations and treaties, A16 border, customs and migration, A17 defense and security forces), then the remaining society, nature and artifact namespaces.
